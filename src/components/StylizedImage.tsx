...
const shapes = [
        ...
        },
        {
            width: 719,
            height: 680,
            path: 'M0 0H719L627.386 662.739C626.019 672.632 617.562 680 607.575 680H0V0Z'
        }
    ]

type ImagePropsWithOptionalAlt = React.ImgHTMLAttributes<HTMLImageElement> & {
    alt?: string;
};
...
export function StylizedImage({
                                  ...
                                  className,
                                  ...props
                              }: ImagePropsWithOptionalAlt & { shape?: 0 | 1 | 2 | 3 }) {
    const id = useId();
