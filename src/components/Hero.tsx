...
export default function Hero ()  {
  return (
      <div className="relative w-full h-screen bottom-20 md:bottom-10 -mb-20 md:-mb-10">
        ...
        {/* Content */}
        <div className="container relative z-10 flex flex-col items-start justify-end text-white px-4 pb-16 md:pb-36 mx-auto h-full">
          ...
          <div className="flex gap-4 flex-col sm:flex-row text-center sm:text-left">
            ...
            <a
                href="#contact"
                className="px-6 py-3 bg-transparent border-2 border-white text-white hover:bg-white hover:text-black font-semibold rounded-lg shadow-md"
            >
              Neem Contact Op
            </a>
          </div>
        ...
        {/* Arrow Down */}
        <div className="absolute bottom-4 md:bottom-10 right-4 md:right-auto md:left-1/2 md:transform md:-translate-x-1/2">
          <a href={"#services"} className="flex justify-center items-center w-12 h-12 border-2 border-white rounded-full motion-safe:animate-bounce">
